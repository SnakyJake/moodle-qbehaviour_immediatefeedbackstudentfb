...
/*
this.CoreSitePluginsHelperProvider["registerComponentInitHandler"] = function registerComponentInitHandler(plugin, handlerName, handlerSchema, delegate, createHandlerFn) {
    debugger;
}.bind(this.CoreSitePluginsHelperProvider);
*/
var result = {
...
setTimeout(()=> {
    that.CoreQuestionBehaviourDelegate.enabledHandlers.immediatefeedbackstudentfb["handleQuestion"] = result["handleQuestion"].bind(that.CoreQuestionBehaviourDelegate.enabledHandlers.immediatefeedbackstudentfb["handleQuestion"]);
});
